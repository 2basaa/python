import numpy as np
import random
import function_mv as functions
...
xpa_s = [functions.squard_df_analytic(x) for x in xv]
...
xpa_r = [functions.restrigin_df_analytic(e) for e in xv]
